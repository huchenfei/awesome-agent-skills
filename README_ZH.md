...
| agentskills/agentskills | ⭐ Agent Skills 官方规范与文档仓库 | 25.1k | [GitHub](https://github.com/agentskills/agentskills) |
| anthropics/skills | ⭐ Anthropic 官方 Agent Skills 仓库 | 174.9k | [GitHub](https://github.com/anthropics/skills) |
...
| awesome-claude-skills | ⭐ Composio 维护的 Claude Skills 合集 | 74.6k | [GitHub](https://github.com/ComposioHQ/awesome-claude-skills) |
| kasetto | 用 Rust 编写的极速 AI 技能管理器 | — | [GitHub](https://github.com/pivoshenko/kasetto) |
| awesome-claude-code | ⭐ Claude Code skills/hooks/插件合集 | 53.6k | [GitHub](https://github.com/hesreallyhim/awesome-claude-code) |
...
| OrkasVideoStudio | 面向 Agent 的视频制作 Skills 合集，配套 CLI 与 MCP 运行时 | 492 | [GitHub](https://github.com/Orkas-AI/Orkas-VideoStudio) |
| Skywork-Skills | Skywork 官方维护的 agent skills，面向 AI 办公场景，覆盖 PPT、文档、Excel、设计、搜索和音乐工作流 | 202 | [GitHub](https://github.com/SkyworkAI/Skywork-Skills) |
| suede-creator-skills | 面向 Claude Code 与 Codex 的 Skills 合集，覆盖代码质量与评审、设计、营销与 SEO、Agent 工作流和移动应用发布 | 133 | [GitHub](https://github.com/JasonColapietro/suede-creator-skills) |
| unifapi-agent/skills | 基于 UnifAPI MCP 的公共数据与 KOL 定价 Skills | 481 | [GitHub](https://github.com/unifapi-agent/skills) |
| youtube-skills | 面向 YouTube 的转录、视频搜索、频道浏览与播放列表 Skills，适用于 Claude Code、OpenClaw、Hermes Agent 等 Agent 运行时 | 805 | [GitHub](https://github.com/ZeroPointRepo/youtube-skills) |
...
| vercel-labs/agent-skills | ⭐ Vercel React/Web 设计最佳实践 Skills（30.9k ⭐） | All | [GitHub](https://github.com/vercel-labs/agent-skills) |
...
| obra/superpowers | ⭐ 完整开发工作流（调试/TDD/代码审查/计划）（282.4k ⭐） | All | [GitHub](https://github.com/obra/superpowers) |
...
| coreyhaines31/marketingskills | ⭐ 营销 Skills（SEO/文案/CRO/广告）（47.6k ⭐） | All | [GitHub](https://github.com/coreyhaines31/marketingskills) |
