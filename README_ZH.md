...
| agentskills/agentskills | ⭐ Agent Skills 官方规范与文档仓库 | 25.3k | [GitHub](https://github.com/agentskills/agentskills) |
| anthropics/skills | ⭐ Anthropic 官方 Agent Skills 仓库 | 176.2k | [GitHub](https://github.com/anthropics/skills) |
...
| microsoft/azure-skills | ⭐ 微软官方 Azure Skills 插件，内置 MCP 配置与 20 个 Azure 技能 | 1.5k | [GitHub](https://github.com/microsoft/azure-skills) |
...
| awesome-claude-skills | ⭐ Composio 维护的 Claude Skills 合集 | 75.0k | [GitHub](https://github.com/ComposioHQ/awesome-claude-skills) |
| kasetto | 用 Rust 编写的极速 AI 技能管理器 | — | [GitHub](https://github.com/pivoshenko/kasetto) |
| awesome-claude-code | ⭐ Claude Code skills/hooks/插件合集 | 54.0k | [GitHub](https://github.com/hesreallyhim/awesome-claude-code) |
...
| cursor-rules-and-prompts | Cursor 规则与提示词集合 | 246 | [GitHub](https://github.com/thehimel/cursor-rules-and-prompts) |
| Ai-Agent-Skills | ⭐ AI Skills 通用安装器（Homebrew for Skills） | 774 | [GitHub](https://github.com/skillcreatorai/Ai-Agent-Skills) |
| claude-code-kit | Claude Code 工具包，自动激活 skills | 102 | [GitHub](https://github.com/blencorp/claude-code-kit) |
| best-skills | 通用高质量 Skills 合集，涵盖论文写作、开发流程、自媒体创作等 | 2.8k | [GitHub](https://github.com/xstongxue/best-skills) |
| skillkit | 跨平台 Skills 管理器，可安装、转换并同步 Skills 到 40+ Agent | 1.5k | [GitHub](https://github.com/rohitg00/skillkit) |
| OrkasVideoStudio | 面向 Agent 的视频制作 Skills 合集，配套 CLI 与 MCP 运行时 | 486 | [GitHub](https://github.com/Orkas-AI/Orkas-VideoStudio) |
| Skywork-Skills | Skywork 官方维护的 agent skills，面向 AI 办公场景，覆盖 PPT、文档、Excel、设计、搜索和音乐工作流 | 204 | [GitHub](https://github.com/SkyworkAI/Skywork-Skills) |
| suede-creator-skills | 面向 Claude Code 与 Codex 的 Skills 合集，覆盖代码质量与评审、设计、营销与 SEO、Agent 工作流和移动应用发布 | 135 | [GitHub](https://github.com/JasonColapietro/suede-creator-skills) |
| unifapi-agent/skills | 基于 UnifAPI MCP 的公共数据与 KOL 定价 Skills | 481 | [GitHub](https://github.com/unifapi-agent/skills) |
| youtube-skills | 面向 YouTube 的转录、视频搜索、频道浏览与播放列表 Skills，适用于 Claude Code、OpenClaw、Hermes Agent 等 Agent 运行时 | 860 | [GitHub](https://github.com/ZeroPointRepo/youtube-skills) |
...
| vercel-labs/agent-skills | ⭐ Vercel React/Web 设计最佳实践 Skills（31.2k ⭐） | All | [GitHub](https://github.com/vercel-labs/agent-skills) |
...
| browser-use/browser-use | 浏览器自动化 Skill（114.5k ⭐） | All | [GitHub](https://github.com/browser-use/browser-use) |
| Xquik x-twitter-scraper | X（Twitter）数据平台 Skill，提供 REST API、MCP 工具、webhooks、SDK 和自动化工作流（198 ⭐） | All | [GitHub](https://github.com/Xquik-dev/x-twitter-scraper) |
...
| obra/superpowers | ⭐ 完整开发工作流（调试/TDD/代码审查/计划）（286.2k ⭐） | All | [GitHub](https://github.com/obra/superpowers) |
...
| coreyhaines31/marketingskills | ⭐ 营销 Skills（SEO/文案/CRO/广告）（50.0k ⭐） | All | [GitHub](https://github.com/coreyhaines31/marketingskills) |
